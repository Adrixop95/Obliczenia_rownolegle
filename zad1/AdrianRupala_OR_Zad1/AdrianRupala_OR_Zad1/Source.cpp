...
int moj_nr, p, c; // Moj_nr -> numer procesu, p -> liczba proces�w, c -> liczba od użytkownika
int counter = 0; // Counter -> liczba wyst�pie� danej liczby
